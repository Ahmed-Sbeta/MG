...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Tasks Create - MAWJA</title>
                                        ...
                                        <form class="outer-repeater"  method="post">
                                            <div data-repeater-list="outer-group" class="outer">
                                                <div data-repeater-item class="outer">
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        <label for="employeeaccount" class="col-form-label col-lg-2">Employee account</label>
                                                        <div class="col-lg-10">
                                                            <input id="employeeaccount" name="employeeaccount" type="text" class="form-control" placeholder="Enter Employee account...">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-4">
                                                        <label for="jobtitle" class="col-form-label col-lg-2">Job Title</label>
                                                        <div class="col-lg-10">
                                                        <select class="form-control select2">
                                                            ...
                                                            <option value="EL">Back End Developer</option>
