                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Add Work</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Add Work</h4>
                                        <form>
                                            <div class="row mb-4">
                                                <label for="worktitle" class="col-form-label col-lg-2">Work Title</label>
                                                <div class="col-lg-10">
                                                    <input id="worktitle" name="worktitle" type="text" class="form-control" placeholder="Work Title...">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-lg-10">
                                                ...
                                                <button type="submit" class="btn btn-info"> <i class="mdi mdi-plus me-1"></i>Add</button>
