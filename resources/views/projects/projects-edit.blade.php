                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('projects.update',[$projects->id])}}" method="post" enctype="multipart/form-data">
                                          ...
                                          @Method('PATCH')
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-lg-10">
                                                    <input id="projectname" name="Pname" type="text" value="{{$projects->name}}" class="form-control" placeholder="Enter Project Name...">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="projectdesc" class="col-form-label col-lg-2">Project Description</label>
                                                <div class="col-lg-10">
                                                    <textarea class="form-control" id="projectdesc" rows="3" name="Pdescription" placeholder="Enter Project Description...">{{$projects->description}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="input-daterange input-group" id="project-date-inputgroup" data-provide="datepicker" data-date-format="dd M, yyyy"  data-date-container='#project-date-inputgroup' data-date-autoclose="true">
                                                        <input type="text" class="form-control" name="startDate" value="{{$projects->start}}" placeholder="Start Date" />
                                                        <input type="text" class="form-control" name="endDate" value="{{$projects->End}}" placeholder="End Date" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-10">
                                                    <div class="fallback">
                                                        <input name="file" type="file" value="{{$projects->file}}" multiple />
                                                    </div>
