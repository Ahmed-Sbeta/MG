                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-15"><a href="/projects/{{$project->id}}" class="text-dark">{{$project->name}}</a></h5>
                                                <p class="text-muted mb-4" style="white-space: nowrap;
                                                width: 180px;
                                                overflow: hidden;
                                                text-overflow: ellipsis;
                                                display: inline-block;">{{$project->description}}</p>
