                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="fullname" name="fullname" type="text" class="form-control" placeholder="Full Name" value="{{Auth::user()->name}}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="phonenumber">Phone Number</label>
                                                        <input id="phonenumber" name="phonenumber" type="text" class="form-control" placeholder="09* *** ** **" value="{{Auth::user()->phoneNumber}}">
                                                    </div>
                                                    <div class="mb-3">
