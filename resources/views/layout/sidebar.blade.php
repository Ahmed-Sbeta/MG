            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/" key="t-default">Profile</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                         <li><a href="/calender" key="t-full-calendar">Full Calendar</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="/orders">Orders</a></li>
                         <li><a href="/orders/create">Order Details</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/email" key="t-inbox">Inbox</a></li>
                        <li><a href="/email" key="t-read-email">Read Email</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/member/create">Add new Member</a></li>
                        <li><a href="/member" key="t-user-list">Users List</a></li>
